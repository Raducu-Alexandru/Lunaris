...
-- Generation Time: Jun 15, 2024 at 12:03 PM
...
CREATE TABLE `adminEvents` (
  `adminEventId` int NOT NULL,
  `userId` int DEFAULT NULL,
  `message` varchar(255) COLLATE utf8mb4_0900_as_cs DEFAULT NULL,
...
INSERT INTO `adminEvents` (`adminEventId`, `userId`, `message`, `createdDate`) VALUES
(1, 1, 'Downloaded Excel Grades for Student Alexandru Mircea123 Raducu12 Year 3 tst4', '2024-06-12 12:00:58'),
(2, 1, 'Updated a grade 9 for Alexandru Mircea123 Raducu12, subject Testefdef', '2024-06-12 15:29:23');
...
(6, 1, 1, NULL, 'dsfdsafasdf', NULL, NULL, '2024-05-23 10:03:15');
...
(1, 6, 7, '2024-04-25 22:52:42', '2024-04-24 07:56:36'),
(2, 2, 5, '2024-04-24 14:20:29', '2024-04-24 14:17:56'),
(2, 6, NULL, '2024-04-25 23:23:59', '2024-04-25 23:23:58'),
(3, 2, 7, '2024-04-24 13:59:40', '2024-04-24 13:50:59'),
(3, 6, 3, '2024-04-24 13:50:30', '2024-04-23 13:47:35'),
(4, 6, NULL, '2024-04-24 12:15:46', '2024-04-24 12:13:31');
...
(3, 2, 17, '2024-04-24 13:50:50'),
(3, 2, 18, '2024-04-24 13:50:56'),
(3, 6, 11, '2024-04-23 13:32:54'),
(3, 6, 16, '2024-04-24 13:50:27'),
(4, 6, 14, '2024-04-24 12:15:41'),
(4, 6, 15, '2024-04-24 12:15:44');
...
(35, 12, 6, NULL, 'hiufvbfvbefwbhd', NULL, NULL, '2024-04-25 22:41:23');
...
(14, '2 (1).docx', '6ec92bc1-23a4-49c4-8765-ff01da7a5f9e.docx', '2024-04-24 12:15:41', 6, '2024-04-24 12:15:41', 2, NULL),
(15, 'mysql-service_lunaris-databases.sql', '0c4defc8-4284-4c22-8b34-7391b034f67e.bin', '2024-04-24 12:15:44', 6, '2024-04-24 12:15:44', 2, NULL),
(16, 'mysql-service_lunaris-databases.sql', '3449c3f2-cfeb-4aec-a7a8-2324d9f13dc9.bin', '2024-04-24 13:50:27', 6, '2024-04-24 13:50:27', 2, NULL),
(17, '2.docx', '7ee53d91-c9bb-4811-a2fd-d3358dfa64f2.docx', '2024-04-24 13:50:50', 2, '2024-04-24 13:50:50', 2, NULL),
(18, 'cafelemansmenu.sql', '24d61562-1b25-4737-af3d-bfbdc91b3a4c.bin', '2024-04-24 13:50:56', 2, '2024-04-24 13:50:56', 2, NULL);
...
(58, 6, '2024-04-23 10:54:59', '2024-04-24 08:05:15', 'web', NULL),
(59, 1, '2024-04-24 08:05:21', '2024-04-24 12:13:03', 'web', NULL),
(60, 6, '2024-04-24 12:13:10', '2024-04-24 12:15:47', 'web', NULL),
(61, 1, '2024-04-24 12:15:52', '2024-06-15 10:41:53', 'web', NULL),
(62, 6, '2024-04-24 12:26:33', '2024-04-24 13:50:33', 'web', NULL),
(63, 2, '2024-04-24 13:50:41', '2024-04-24 14:21:12', 'web', NULL),
(64, 6, '2024-04-25 22:34:04', '2024-04-25 22:59:20', 'web', NULL),
(65, 6, '2024-04-25 23:23:45', '2024-04-27 09:07:50', 'web', NULL);
...
(1, 'Testefdef', 11, 0, '2024-03-28 12:52:23', 1),
...
--
ALTER TABLE `adminEvents`
  MODIFY `adminEventId` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `classesMessages`
  MODIFY `classMessageId` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;
...
--
ALTER TABLE `files`
  MODIFY `fileId` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
...
--
ALTER TABLE `logins`
  MODIFY `loginId` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=66;
...
--
-- Constraints for table `adminEvents`
--
ALTER TABLE `adminEvents`
  ADD CONSTRAINT `adminevents_ibfk_1` FOREIGN KEY (`userId`) REFERENCES `users` (`userId`);
