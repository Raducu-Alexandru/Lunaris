...
(14, 1, 9.68, 10, '2024-04-14 13:59:29');
...
(43, 1, '2024-04-13 13:00:17', '2024-04-14 14:48:56', 'web', NULL),
...
--
ALTER TABLE `classesMembers`
  MODIFY `classMemberId` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;

--
-- AUTO_INCREMENT for table `classesMessages`
--
ALTER TABLE `classesMessages`
  MODIFY `classMessageId` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `logins`
  MODIFY `loginId` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=45;
