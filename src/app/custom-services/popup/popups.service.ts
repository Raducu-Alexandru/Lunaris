...
export type PopupType = 'confirmation' | 'alert' | 'alert-confirmation' | 'info' | 'warning' | 'text-input' | 'dropdown-select' | 'select-program-year' | 'number-input' | 'checkmark' | 'user-contact';
