...
export class DashboardIndexPageComponent implements OnInit {
  ...
  constructor(private _userRoleService: UserRoleService, private _authenticateService: AuthenticateService) { }
  ...
  private async _getUserEmail(): Promise<string> {
    var responseObject: ResponseObject = await this._authenticateService.sendGetReq(environment.userDetailsUrl + '/get/user-email');
